...
class ThingspeakEnvFact(factabc.APIEnvFact):

    def __init__(self, path_to_env: str, command_name: str, command_type: str):
        super(ThingspeakEnvFact, self).__init__(path_to_env=path_to_env, command_name=command_name, command_type=command_type)
    ...
    def craft_env(self) -> envtype.APIEnv:
        ...
        for lookup in db_lookup:
            for channel in lookup.channels:
                ...
                query_executor = exetype.StationMeasureQueryExecutor(
