...
class ThingspeakEnvFact(factabc.APIEnvFactABC):
    ...
    def craft_env(self) -> envtype.Environment:
        ...
        for api_param in super().api_param:
            ...
            url_builder = urltype.ThingspeakTimeIterableURL(url=private_url, from_=api_param.last_acquisition, to_=tstype.CurrentTimestamp())
            ...
            resp_builder = builder.ThingspeakAPIRespBuilder(channel_name=api_param.ch_name)
