...
class AtmotubeAPIRequest(APIRequest):
    ...
    def fetch(self, query_string: str) -> str:
        ...
        try:
            ...
            raise SystemExit(f"{AtmotubeAPIRequest.__name__}: {str(err)}")
        finally:
            req.urlcleanup()
        return response
