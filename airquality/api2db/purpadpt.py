...
class PurpAPIRespAdpt(adpt.APIRespAdapt):
    ...
    def _get_channel_param(self, r: resp.PurpAPIResp) -> List[adptype.sel.ChannelParam]:
        return [adptype.sel.ChannelParam(
    ...
    def _get_geolocation(self, r: resp.PurpAPIResp) -> adptype.Geolocation:
        return adptype.Geolocation(timestamp=self.timestamp_cls(r.date_created),
