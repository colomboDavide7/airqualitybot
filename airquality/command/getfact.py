...
def get_command_factory_cls(command_name: str, command_type: str):

    if command_name == 'init':
        return initfact.get_init_factory_cls(command_type=command_type)
    elif command_name == 'update':
        return updtfact.get_update_factory_cls(command_type=command_type)
    elif command_name == 'fetch':
        return fetchfact.get_fetch_factory_cls(command_type=command_type)
    else:
