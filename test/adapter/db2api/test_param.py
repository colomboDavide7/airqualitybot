...
class TestParamAdapter(unittest.TestCase):
    ...
    def test_successfully_reshape_atmotube_api_param(self):
        ...
        expected_output = [{c.MAC_ADDR: 'some_mac', c.API_KEY: 'some_key', c.CH_NAME: c.ATMOTUBE_CHANNEL}]
    ...
    def test_successfully_uniform_reshape_thingspeak_api_param(self):
        ...
        expected_output = [{c.CH_ID: 'id1A', c.API_KEY: 'key1A', c.CH_NAME: c.FST_CH_A},
                           {c.CH_ID: 'id1B', c.API_KEY: 'key1B', c.CH_NAME: c.FST_CH_B},
                           {c.CH_ID: 'id2A', c.API_KEY: 'key2A', c.CH_NAME: c.SND_CH_A},
                           {c.CH_ID: 'id2B', c.API_KEY: 'key2B', c.CH_NAME: c.SND_CH_B}]
