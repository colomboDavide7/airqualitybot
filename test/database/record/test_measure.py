...
class TestMeasurementRecord(unittest.TestCase):
    ...
    def test_successfully_build_station_record(self):
        test_data = {'record_id': 99, 'param': [{'id': 1, 'val': 55}],
                     'timestamp': {'class': ts.ThingspeakTimestamp, 'kwargs': {'timestamp': '2018-10-11T09:44:00Z'}}}
    ...
    def test_successfully_build_mobile_record(self):
        test_data = {'record_id': 99, 'param': [{'id': 1, 'val': 55}],
                     'timestamp': {'class': ts.AtmotubeTimestamp, 'kwargs': {'timestamp': '2018-10-11T09:44:00.000Z'}},
