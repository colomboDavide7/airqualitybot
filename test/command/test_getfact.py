...
class TestCommandFactory(unittest.TestCase):
    ...
    def test_successfully_get_purpleair_init_command_class(self):
        ...
        actual_cls = get.get_command_factory_cls(command_name=test_command_name, command_type=test_sensor_type)
    ...
    def test_exit_on_update_command_bad_sensor_type(self):
        ...
        with self.assertRaises(SystemExit):
            get.get_command_factory_cls(command_name=test_command_name, command_type=test_sensor_type)
