...
class TestAddStationMeasures(TestCase):
    ...
    def test_add_station_measures(self, mocked_datetime, mocked_get):
        ...
        mocked_gateway.get_last_acquisition_of_sensor_channel.return_value = \
            datetime.strptime('2021-12-20 11:17:40', '%Y-%m-%d %H:%M:%S')

        use_case = AddThingspeakMeasures(
