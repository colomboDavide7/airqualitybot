...
class TestUniversalDatabaseAdapter(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.thingspeak_adapter = rshp.ThingspeakUniformReshaper()
        self.purpleair_adapter = rshp.PurpleairUniformReshaper()
        self.atmotube_adapter = rshp.AtmotubeUniformReshaper()
    ...
    def test_successfully_adapt_purpleair_packets(self):
        ...
        actual_output = self.purpleair_adapter.api2db(test_packet)
    ...
    def test_system_exit_when_key_error_occur_purpleair_container_adapter(self):
        ...
        with self.assertRaises(SystemExit):
            self.purpleair_adapter.api2db(test_packet)
    ...
    def test_successfully_adapt_atmotube_packet(self):
        ...
        actual_output = self.atmotube_adapter.api2db(test_packet)
        self.assertEqual(actual_output, expected_output)
    ...
    def test_system_exit_when_param_is_missing(self):
        ...
        test_packet = {'voc': 'val1', 'pm1': 'val2', 'pm25': 'val3', 'pm10': 'val4', 't': 'val5', 'h': 'val6',
                       'p': 'val7', 'coords': {}}
        with self.assertRaises(SystemExit):
            self.atmotube_adapter.api2db(test_packet)
    ...
    def test_successfully_adapt_thingspeak_packets(self):
        ...
        actual_output = self.thingspeak_adapter.api2db(test_packet)
        self.assertEqual(actual_output, expected_output)
    ...
    def test_system_exit_when_key_error_is_raised(self):
        ...
        with self.assertRaises(SystemExit):
            self.thingspeak_adapter.api2db(test_packet)
