...
class TestURLBuilder(unittest.TestCase):
    ...
    def test_successfully_build_purpleair_url(self):
        ...
        purpleair_builder = url.PurpleairURL(address=self.api_address, querystr_param=test_param)
    ...
    def test_system_exit_when_building_purpleair_url(self):
        ...
        with self.assertRaises(SystemExit):
            url.PurpleairURL(address=self.api_address, querystr_param=test_param_missing_key)

        test_param_missing_fields = {"api_key": "some_key", "opt": "val"}
        with self.assertRaises(SystemExit):
            url.PurpleairURL(address=self.api_address, querystr_param=test_param_missing_fields)

        test_param_empty_fields = {"api_key": "some_key", "fields": [], "opt": "val"}
        builder = url.PurpleairURL(address=self.api_address, querystr_param=test_param_empty_fields)
        with self.assertRaises(SystemExit):
            builder.url()
    ...
    def test_successfully_build_atmotube_url(self):
        ...
        atmotube_builder = url.AtmotubeURL(address=self.api_address, querystr_param=test_param)
    ...
    def test_system_exit_when_building_atmotube_url(self):
        ...
        with self.assertRaises(SystemExit):
            url.AtmotubeURL(address=self.api_address, querystr_param=test_param_missing_key)

        test_param_missing_mac = {"api_key": "key", "opt": "val"}
        with self.assertRaises(SystemExit):
            url.AtmotubeURL(address=self.api_address, querystr_param=test_param_missing_mac)
    ...
    def test_successfully_build_thingspeak_url(self):
        ...
        thingspeak_builder = url.ThingspeakURL(address=self.api_address, querystr_param=test_param)
    ...
    def test_system_exit_when_building_thingspeak_url(self):
        ...
        with self.assertRaises(SystemExit):
            url.ThingspeakURL(address=self.api_address, querystr_param=test_param_missing_id)

        test_param_missing_format = {"channel_id": "id", "api_key": "key", "opt": "val"}
        with self.assertRaises(SystemExit):
            url.ThingspeakURL(address=self.api_address, querystr_param=test_param_missing_format)

        test_param_missing_key = {"channel_id": "id", 'format': 'json', "opt": "val"}
        with self.assertRaises(SystemExit):
            url.ThingspeakURL(address=self.api_address, querystr_param=test_param_missing_key)
